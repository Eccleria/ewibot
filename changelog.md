## 7.2.1
- Fix: order not matching betweens `buttons` and `all-roles` description in `embed` ([#443](https://github.com/Eccleria/ewibot/pull/443))
...
- New: `gift send` now use a modal for `content` formating + `gift get` & `gift remove` reworked ([#396](https://github.com/Eccleria/ewibot/pull/396))
